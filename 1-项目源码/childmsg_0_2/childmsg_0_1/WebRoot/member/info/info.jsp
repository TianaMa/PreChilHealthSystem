	...
	<form action="<%=basePath %>Member.do?method=UPREGINFO" method="post" name="regform" onSubmit="return checkpersonreg()">
       <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		  ...
		  <TR align="center" bgColor=#ffffff>
		   ...
		   <TR align="center" bgColor=#ffffff>
			<TD width="30%" align="right" >提示问题：</TD>
			<TD width="70%" align="left" id=map>
			<INPUT class=inputb maxLength=28 size=30 name=question  value="<%=list.get(8).toString() %>"> <FONT color=#ff0000>**</FONT>&nbsp; 
			</TD>
		  </TR>
		  <TR align="center" bgColor=#ffffff>
			<TD width="30%" align="right" >问题答案：</TD>
			<TD width="70%" align="left" id=map>
			<INPUT class=inputb maxLength=28 size=30  name=answer value="<%=list.get(9).toString() %>"> <FONT color=#ff0000>**</FONT> <br></TD>
		  </TR>
		   <TR align="center" bgColor=#ffffff>
			<TD width="30%" align="right" >病史：</TD>
			<TD width="70%" align="left" id=map>
