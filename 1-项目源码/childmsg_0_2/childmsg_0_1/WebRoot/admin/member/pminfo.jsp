...
<jsp:useBean id="mmb" scope="page" class="com.lzl.child.bean.MemberManageBean" ></jsp:useBean>
...
<TABLE width="100%" border=1 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
   ...
   <tr>
   <td align=right>编号：</td><td align=left><%=list.get(2).toString() %></td>
   </tr>
   <tr>
   ...
   <tr>
   <td align=right>配偶名称：</td><td align=left><%=list.get(7).toString() %></td>
   </tr>
   <tr>
   <td align=right>负责医生：</td><td align=left><%=list.get(8).toString() %></td>
   </tr>
   <tr>
   <td align=right>病史：</td><td align=left><%=list.get(9).toString() %></td>
   </tr>
   <tr>
