...
<jsp:useBean id="sys" scope="page" class="com.lzl.child.bean.SystemBean"></jsp:useBean>
<jsp:useBean id="guestbean" scope="page" class="com.lzl.child.bean.GuestBookBean"></jsp:useBean>
<%
