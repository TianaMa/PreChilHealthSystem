<%@ page contentType="text/html; charset=gb2312" language="java" import="java.sql.*,java.util.*,com.lzl.child.util.*" errorPage="" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<jsp:useBean id="yzm" scope="page" class="com.lzl.child.util.CheckCode"/>
<jsp:useBean id="sdir" scope="page" class="com.lzl.child.bean.SystemBean"/>
<%
        ...
        <tr>
          ...
          <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="36" style="text-align:center;"><br><br><h3><%=str %></h3></td>
              </tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
			   ...
			   <tr>
				<input width="70" type="button" height="60" onclick="history.go(-1)" value="返回上一页"  style="margin-top: 20px;"/>
			   </tr>
            </table>
          </td>
          <td bgcolor="#4047A4" width="1"></td>
