...
%>
         ...
         <TABLE  height=237 cellSpacing=0  cellPadding=0 width="100%" border=0 hspace="12">
						  ...
						  <TR >
						    <TD vAlign=center align=right  height=26>&nbsp; 编号：</TD>
						    <TD width=556 height=26 align=left>
                          ...
                          <TR >
                            <TD vAlign=center align=right height=12>家庭病史：</TD>
                            <TD height=12 align=left>
						...
						<INPUT class=inputb maxLength=28 size=30 name=question> <FONT color=#ff0000>**</FONT></TD></TR>
                          <TR >
                            <TD vAlign=center align=right  height=17>&nbsp; 问题答案：</TD>
                            <TD width=556 height=17 align=left>
							<INPUT class=inputb maxLength=28 size=30  name=answer> <FONT color=#ff0000>**</FONT>&nbsp; </TD></TR>
                          <TR>
