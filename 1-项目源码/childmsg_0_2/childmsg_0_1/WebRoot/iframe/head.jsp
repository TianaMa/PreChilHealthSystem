...
<jsp:useBean id="sys" scope="page" class="com.lzl.child.bean.SystemBean" /> 
<jsp:useBean id="abc" scope="page" class="com.lzl.child.bean.AfficheBean"/> 
  ...
  <TR>
    <TD>
    	<DIV class=ad id=banner>
    		<img src="images/a111.png" width="950" height="110" border=0>
    	</DIV>
    </TD>
  </TR>
 </TBODY>
...
<TABLE id=toplogin cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
  ...
  <TR>
    <TD vAlign=center align=left>
      ...
      【<a href="login_new.jsp">会员登录</a>】【<a href="reg.jsp">免费注册</a>】【<a href="lost.jsp">忘记密码</a>】
      <%}else{   %>
      欢迎您，尊敬的会员：<%=member2 %> <A href="member/index.jsp" target="">【会员中心】</A>
      <%} %>【<A href="news.jsp" target="">新闻动态</A>】      </DIV>
...
<TBODY>
  <TR>
	...
	<A href="index_new.jsp" target="">首    页</A> | 	 
    <A href="guestbook.jsp" target="">留言咨询</A> | 
	<A href="member/index.jsp" target="">会员中心</A> | 
	<A href="admin/login.jsp" target="">管理登陆</A> | 
	<A href="news.jsp" target="">新闻动态</A> |
    <A href="login.jsp" target="">新生儿系统</A>
	<!--****************主菜单结束****************-->
	</TD>
  </TR>
</TBODY>
