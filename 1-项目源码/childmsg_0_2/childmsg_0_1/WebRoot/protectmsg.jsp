...
<script type='text/javascript' src='/childmsg/dwr/interface/protectDao.js'></script>
...
<body>
	 <table width="100%" border=0 align=center cellpadding=2 cellspacing=1 class=tableBorder>
      <tr>
        <th align=center style="height: 23px"><span id="innerTitle">保健信息查询</span></th>
      </tr>
   	   <tr bgcolor="#DEE5FA"><td class="txlrow" align="center">
   	   		<table align="center" width="70%" cellpadding="2" cellspacing="2" border="0" style="border: 1px solid black;">
   	   			<tr><td align="center" colspan="3"><h1>保健信息</h1></td></tr>
...
<script type="text/javascript">
	function sels(){
		...
		protectDao.getByNum(num,function(rs){
				if(rs ==  null || rs == ""){
					alert("没有信息");
					...
					var show = "<table width=100% border=0><tr><th width=30%>保健医生</th><th width=30%>保健诊室</th><th>保健时间</th></tr>";
					for(var i = 0;i<rs.length;i++){
							show += "<tr><td>"+rs[i].doctor+"</td><td>"+rs[i].room+"</td><td>"+rs[i].stime+"</td></tr>";
					}
					show += "</table>";
