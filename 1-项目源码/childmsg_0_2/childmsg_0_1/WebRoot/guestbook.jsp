...
<jsp:useBean id="guestbean" class="com.lzl.child.bean.GuestBookBean" scope="page" /> 
...
<TABLE  cellSpacing=0 cellPadding=0 width="950" border=0>
        ...
        <TR>
          <TD >
<TABLE class=dragTable height=28 cellSpacing=0 cellPadding=0 width=950 align=center background=<%=basePath %>images/head1.gif border=0>
  <TBODY>
  <TR>
    <TD align=left class=head><FONT color=#000000>您现在的位置：<SPAN 
                        style="TEXT-DECORATION: none">心理咨询</FONT>
	</TD>
	</TR>
  </TBODY>
</TABLE></TD></TR>
                  ...
                  <TABLE style="TABLE-LAYOUT: fixed; WORD-WRAP: break-word" cellSpacing=0 cellPadding=0 width="80%" border=0>
                    ...
                    <TR>
					  ...
					  <IMG height=20 src="<%=basePath+pagelist2.get(7).toString() %>" width=20> 
                        ...
                        %>
                        <FIELDSET>
						<LEGEND>心理咨询回复 </LEGEND><%=replay.get(0).toString() %> 
...
<TABLE height=28 cellSpacing=0 cellPadding=0 width=950 align=center border=0>
        <TBODY>
        <TR>
          <TD align=left class=head>&nbsp;我要心理咨询</TD></TR>
        <TR>
          <TD class=middle>
...
<FORM name="form1" action="<%=basePath%>GuestBook.do?method=add" method="post" onSubmit="return checkGUEST()" >
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD width="24%" align="right">心理咨询内容:</TD>
