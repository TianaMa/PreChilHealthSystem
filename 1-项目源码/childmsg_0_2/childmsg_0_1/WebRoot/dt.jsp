...
<%
	...
	if(username2==null){
		...
		String sj=cb.getString("select sj from sjmc where id='"+sjid+"'");
		int sss=Integer.parseInt(sj)*60*1000;
...
<form action="<%=basePath %>ComServlet?method=stuDT&sjid=<%=sjid%>" name="form1" method=post >
	...
	<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      ...
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><select name="ok<%=pagelist2.get(0).toString()%>">
...
%>  
	<tr> <input type="hidden" name="time_end" value="<%=sgs %>">
      <td colspan=5 align="center"><input id="btn" type=submit value="提交"></td>  
    </tr>
    <tr> 
      <td colspan=5 align="center">剩余时间：<div id="timer"></div></td>  
    </tr>
