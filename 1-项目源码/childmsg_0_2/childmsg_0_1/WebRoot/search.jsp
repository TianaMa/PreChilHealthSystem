...
//-->
     ...
     <TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
          <TD width=350 align=right>产品类别：</TD><TD align=left>
<select name="jd">
    ...
    <%}} %>
		...
		<TR>
          <TD  align=right>产品名称关键字：</TD><TD align=left><input type=text name=title size=30 ></TD>
		</TR>
