<%@ page language="java" import="java.util.*,com.lzl.child.util.Common" contentType="text/html;charset=gb2312" %>
...
//-->
     ...
     <TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
      ...
      <td  align="center">发布时间</td> 
       ...
       fl=Common.toChineseAndTrim(fl);
       List pagelist3=cb.getCom("select * from info where fl='"+fl+"' order by id desc",5);
